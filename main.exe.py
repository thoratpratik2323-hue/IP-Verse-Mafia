...
class IPRayLive:
    ...
    async def _listen_audio(self):
        ...
        def callback(indata, frames, time_info, status):
            ...
            if not ip_ray_speaking and not self.ui.muted:
            ...
            while True:
                async for response in self.session.receive():
                    ...
                    if response.server_content:
                        ...
                        if sc.input_transcription and sc.input_transcription.text:
                            ...
                            if txt:
                                ...
                                # Check for vocal fullscreen triggers
                    ...
                    if response.tool_call:
                        if self._wake_active and time.time() - self._wake_timer > 300:
                            self._wake_active = False
                            self.ui.write_log("SYS: Sleep mode activated after 5 minutes of inactivity.")
        ...
        try:
            while True:
                ...
                try:
                    ...
                    # 3.0x multiplier for robust, loud and clear voice feedback
